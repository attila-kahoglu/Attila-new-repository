...
public class IteratorDemoWithExcel {
    ...
    public List<String> getInfo (String name, String sheetName, int column) {
        String filePath = "testdatafolders/myDocument.xlsx";
    ...
    public static void main(String[] args) {
        IteratorDemoWithExcel demoWithExcel = new IteratorDemoWithExcel();
        List<String> customerInfo = demoWithExcel.getInfo("David","CustomerInfo",1);
